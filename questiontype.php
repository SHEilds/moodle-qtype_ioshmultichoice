...
class qtype_ioshmultichoice extends question_type {
    ...
    public function save_question_options($question) {
        ...
        if ($options->single) {
            ...
            if ($totalfraction != 1) {
                $result->noticeyesno = get_string('fractionsaddwrong', 'qtype_ioshmultichoice',
                        $totalfraction * 100);
                return $result;
            }
        }
    ...
    protected function make_question_instance($questiondata) {
        ...
        if ($questiondata->options->single) {
            $class = 'qtype_ioshmultichoice_single_question';
        } else {
            $class = 'qtype_ioshmultichoice_multi_question';
        }
        return new $class();
    }
    ...
    protected function initialise_question_instance(question_definition $question, $questiondata) {
        ...
        if (!empty($questiondata->options->layout)) {
            ...
            $question->layout = qtype_ioshmultichoice_single_question::LAYOUT_VERTICAL;
        }
     ...
     *      should be a lang string answernumberingxxx in teh qtype_ioshmultichoice
    ...
    public static function get_numbering_styles() {
        ...
        foreach (array('abc', 'ABCD', '123', 'iii', 'IIII', 'none') as $numberingoption) {
            $styles[$numberingoption] =
                    get_string('answernumbering' . $numberingoption, 'qtype_ioshmultichoice');
        }
        return $styles;
    }
