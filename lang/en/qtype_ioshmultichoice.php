...
/**
 * Strings for component 'qtype_ioshmultichoice', language 'en', branch 'MOODLE_20_STABLE'
 *
 * @package    qtype
...
$string['pluginname'] = 'IOSH Multiple choice';
...
$string['pluginname_link'] = 'question/type/ioshmultichoice';
$string['pluginnameadding'] = 'Adding an IOSH Multiple choice question';
$string['pluginnameediting'] = 'Editing an IOSH Multiple choice question';
$string['pluginnamesummary'] = 'Allows the selection of a single or multiple responses from a pre-defined list with a hard limit on correct questions.';
$string['privacy:metadata'] = 'The IOSH Multiple choice question type plugin does not store any personal data.';
