...
require_once($CFG->dirroot . '/question/type/ioshmultichoice/questiontype.php');
require_once($CFG->dirroot . '/question/type/edit_question_form.php');
require_once($CFG->dirroot . '/question/type/ioshmultichoice/edit_ioshmultichoice_form.php');
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qtype_ioshmultichoice_test extends advanced_testcase {
    protected $qtype;

    protected function setUp() {
        $this->qtype = new qtype_ioshmultichoice();
    }
    ...
    public function test_name() {
        $this->assertEquals($this->qtype->name(), 'ioshmultichoice');
    }
    ...
    public function test_question_saving_two_of_four($which) {
        ...
        $questiondata = test_question_maker::get_question_data('ioshmultichoice', $which);
        $formdata = test_question_maker::get_question_form_data('ioshmultichoice', $which);

        $generator = $this->getDataGenerator()->get_plugin_generator('core_question');
        $cat = $generator->create_question_category(array());

        $formdata->category = "{$cat->id},{$cat->contextid}";
        qtype_ioshmultichoice_edit_form::mock_submit((array)$formdata);

        $form = qtype_ioshmultichoice_test_helper::get_question_editing_form($cat, $questiondata);
    ...
    public function test_get_question_options() {
        ...
        $questiondata = test_question_maker::get_question_data('ioshmultichoice', 'two_of_four');
        $formdata = test_question_maker::get_question_form_data('ioshmultichoice', 'two_of_four');
        ...
        $DB->delete_records('qtype_ioshmultichoice_opts', ['questionid' => $question->id]);
        ...
        $this->assertEquals(get_config('qtype_ioshmultichoice', 'answerhowmany'), $options->single);
