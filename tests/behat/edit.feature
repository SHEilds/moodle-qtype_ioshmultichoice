...
Feature: Test editing a Multiple choice question
  ...
  Background:
    ...
    And the following "questions" exist:
      ...
      | Test questions   | ioshmultichoice | Multiple choice for editing | two_of_four |
      | Test questions   | ioshmultichoice | Single choice for editing   | one_of_four |
