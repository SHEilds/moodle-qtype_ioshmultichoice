...
/**
 * Upgrade library code for the ioshmultichoice question type.
 *
 * @package    qtype
...
/**
 * Class for converting attempt data for ioshmultichoice questions when upgrading
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qtype_ioshmultichoice_qe2_attempt_updater extends question_qtype_attempt_updater
{
    protected $order;

    public function is_blank_answer($state)
    {
        // Blank ioshmultichoice answers are not empty strings, they rather end in a colon.
