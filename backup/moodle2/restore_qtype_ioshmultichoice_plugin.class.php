...
class restore_qtype_ioshmultichoice_plugin extends restore_qtype_plugin {
    ...
    public function process_ioshmultichoice($data) {
        ...
        if ($questioncreated) {
            ...
            // Insert record
            $newitemid = $DB->insert_record('question_ioshmultichoice', $data);
            // Create mapping (needed for decoding links)
            $this->set_mapping('question_ioshmultichoice', $oldid, $newitemid);
        }
    }
    ...
    public static function define_decode_contents() {
        ...
        $contents[] = new restore_decode_content('question_ioshmultichoice',
                $fields, 'question_ioshmultichoice');
